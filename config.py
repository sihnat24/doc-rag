...
TOOL_PROMPT = (
    ...
    "- query_spreadsheet: run a SQL SELECT query against the risk_budget_tracker table. "
    "Use this for precise lookups, filtering, or aggregations on program tracker data "
    "(e.g. budget totals, red-risk subsystems, vendor comparisons).\n"
